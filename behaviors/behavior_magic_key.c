...
static void history_push(struct magic_key_data *data,
                         uint32_t encoded) {
    data->history[data->head] = encoded;

    data->head =
        (data->head + 1) % MAGIC_KEY_HISTORY_SIZE;
...
#define MK_SEQ_INIT(child)                                           \
    {                                                                 \
        ...
        .antecedent_len =                                             \
            ARRAY_SIZE(mk_antecedent_##child),                        \
        .bindings = mk_bindings_##child,                              \
        .binding_len =                                                \
            ARRAY_SIZE(mk_bindings_##child),                          \
    },
        ...
        mk_sequences_##n[] = {                                        \
            DT_FOREACH_CHILD(                                         \
                ...
                MK_SEQ_INIT                                           \
                                                                      ...
                                                                      \
    static const struct magic_key_config                              \
        mk_cfg_##n = {                                                \
            .max_delay_ms =                                           \
            ...
            .sequences =                                              \
                mk_sequences_##n,                                     \
                                                                      \
            .sequence_count =                                         \
                ARRAY_SIZE(mk_sequences_##n),                         \
                                                                      \
            .fallback_bindings =                                      \
                mk_fallback_bindings_##n,                             \
                                                                      \
            .fallback_bindings_len =                                  \
                ARRAY_SIZE(mk_fallback_bindings_##n),                 \
    };                                                                \
                                                                      \
